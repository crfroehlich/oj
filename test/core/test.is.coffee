...
QUnit.test 'NaN is a number and only a number', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '-Infinity is a number and only a number', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '"" is a string and only a string', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '"false" is a String and only a String', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '"true" is a String and only a String', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test 'false is a Boolean and only a Boolean', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test 'true is a Boolean and only a Boolean', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '[] is an Array and not any other type', ->
  expect 8 #all 8 assertions must pass
...
QUnit.test '{} is an Object and not any other type', ->
  expect 8 #all 8 assertions must pass
  deepEqual OJ.is.string({}), false, '{} is not a String'
  deepEqual OJ.is.bool({}), false, '{} is not a Boolean'
  deepEqual OJ.is.number({}), false, '{} is not a Number'
...
QUnit.test 'OJ.is.nullOrUndefined', ->
