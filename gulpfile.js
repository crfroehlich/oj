...
(function() {
  var autoprefixer, bump, cache, clean, coffee, coffeelint, concat, debug, extended, files, git, gulp, gulpBowerFiles, gutil, header, imagemin, inject, injectDependencies, js2coffee, jshint, less, livereload, lr, minifyCss, notify, path, paths, pkg, plugins, plumber, qunit, rename, server, succint, uglify, watch, wiredep;
  ...
  gulp.task('compile', ['coffee', 'inject', 'init']);
