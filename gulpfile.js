...
(function() {
  var autoprefixer, bump, cache, clean, coffee, coffeelint, concat, debug, extended, files, git, gulp, gutil, header, imagemin, inject, livereload, lr, minifyCss, notify, path, paths, pkg, plugins, qunit, rename, server, succint, uglify, watch, wiredep, wiredepStream;
