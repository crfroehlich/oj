...
(function() {
  var autoprefixer, bump, cache, clean, coffee, coffeelint, compileInPlace, concat, debug, extended, files, git, gulp, gutil, header, imagemin, inject, injectTask, livereload, lr, minifyCss, notify, path, paths, pkg, plugins, qunit, rename, server, sourceMaps, succint, uglify, watch, wiredep, wiredepStream;
