...
(function() {
  var autoprefixer, bump, cache, clean, coffee, coffeelint, concat, debug, docco, extended, files, git, gulp, gulpBowerFiles, gutil, header, imagemin, inject, js2coffee, jshint, less, livereload, lr, minifyCss, notify, path, paths, pkg, plugins, plumber, qunit, rename, server, succint, uglify, watch, wiredep, wiredepStream;
  ...
  gulp.task('docco', function() {
    return gulp.src('./src/coffee/**/*.coffee').pipe(docco()).pipe(gulp.dest('./docs'));
  });
