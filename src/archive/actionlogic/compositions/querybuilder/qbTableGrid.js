...
(function (OJ) {
    ...
    var onInit = function (thisGrid) {
        ...
        var model;
        var selModel = OJ.selections.selectionModelCheckBox({
    ...
    */
     ...
     * Add the subscribers
    */
    grid.subscribers.add(OJ.grids.constants.subscribers.bodyscroll, function () {
    ...
    grid.subscribers.add(OJ.grids.constants.subscribers.drop, function (node, data, dropRec, dropPosition) {
