...
(function() {
  ...
  (_treelIIFE = function(OJ) {
     ...
     */
    var Sheet, sheetProperties, sheetfunc;
     ...
     */
    Sheet = function(name, requires, extend, alias, id, store, plugins, onInit) {
      "use strict";
      var that;
     ...
     */
    OJ.sheets.register("sheet", sheetfunc = function(sheetDef) {
      "use strict";
      var sheet;
      if (!sheetDef) {
